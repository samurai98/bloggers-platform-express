...
import { blogValidation, blogsQueryValidation, postsByBlogQueryValidation, deleteBlogValidation } from './validation';
...
blogsRouter.put('/:id', blogValidation, async (req: Request<ParamId, {}, ReqBodyBlog>, res: Response<ResType>) => {
