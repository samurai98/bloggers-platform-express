...
export const incorrectQuery = {
  ...
  incorrect: '&pageNumber=qwerty&pageSize=text&sortBy[test]=ip&sortDirection[]=ask',
} as const;

export const validBlogs: ReqBodyBlog[] = [
  { name: 'Blog 1', websiteUrl: 'https://youtube.com', description: 'Lorem Ipsum' },
  {
    name: 'Second',
...
export const validPosts: Partial<ReqBodyPost>[] = [
  { title: 'first post', content: 'some content', shortDescription: 'description' },
  { title: 'abc title', content: 'content qwerty', shortDescription: 'short about' },
  { title: 'title ABc', content: '1 some content', shortDescription: '2description' },
  { title: '12345', content: '2 content', shortDescription: '2description' },
  {
    title: '0title',
